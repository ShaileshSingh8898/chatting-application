    ...
    Server(){
       ...
       ImageIcon i3= new ImageIcon(i2);
        ...
        public void mouseClicked(MouseEvent ae){
          ...
          ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/nobita.png"));
...
f.add(a1);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
         ...
         JPanel right=new JPanel(new BorderLayout());//your message is aligned at right side
